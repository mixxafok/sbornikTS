      ...
      <div>
       ...
       <div className={modalOpen ? 'modal_accord' : 'none'}>
          ...
          <main className={isStyle === 'true' ? 'main_song songDark' : 'main_song'} style={{fontSize: `${JSON.parse(slide) }px`}}>
                  ...
                  <p id={viewAccordes ? '' : 'none'} className={isStyle === 'true' ? 'main-song-accord accDark' : 'main-song-accord '} > {major[9+start]} &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  {major[2+start]} &emsp;&emsp; {major[4+start]} &emsp;&emsp; {major[9+start]} <br/></p>               
                  ...
                  <p id={viewAccordes ? '' : 'none'} className={isStyle === 'true' ? 'main-song-accord accDark' : 'main-song-accord '} >  {major[9+start]}  &emsp;&emsp;&emsp;&emsp;&emsp;  {major[2+start]} &emsp;&emsp;&emsp;&emsp;&emsp; {minor[4+start]} {major[9+start]} <br/></p>               
